...
public class NodeActivityMetric extends Metric {
  private static final String countName = "NACount";
  
  private static final String valueName = "NAValue";
  
  @Override
  public String[][] evaluate(final GraphStatistic g) {
    final HashMap<Integer, Integer> map = new HashMap<Integer, Integer>();
    final Consumer<EObject> _function = (EObject it) -> {
      final int value = g.numOfEdgeTypes(it);
    ...
    datas[0][0] = NodeActivityMetric.valueName;
    datas[1][0] = NodeActivityMetric.countName;
    int count = 1;
